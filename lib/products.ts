...
export const products: Product[] = [
  {
    ...
    colors: [
      { name: "Hot Pink", hex: "#FF1E8E" },
      { name: "Bubblegum", hex: "#FF8FC4" },
      { name: "Ballet", hex: "#FFC9E2" },
    ],
    art: "teardrop",
    accent: "#FF1E8E",
  },
  ...
  },
  {
    ...
    colors: [{ name: "Cream / Black", hex: "#141115" }],
    art: "brushes",
    accent: "#141115",
  },
  {
    ...
    colors: [{ name: "Natural / Pink", hex: "#FF1E8E" }],
    art: "puff",
    accent: "#FF1E8E",
  },
  {
    ...
    colors: [{ name: "Cream / Pink", hex: "#FF1E8E" }],
    art: "set",
    accent: "#FF1E8E",
  },
  {
    ...
    colors: [{ name: "Natural", hex: "#F4EBDD" }],
    art: "tote",
    accent: "#FF1E8E",
  },
  {
    ...
    colors: [{ name: "Pink / Black", hex: "#FF1E8E" }],
    art: "sticker",
    accent: "#FF1E8E",
  },
];
